 ...
 * \sa SDL_OpenIO
 */
extern DECLSPEC SDL_bool SDLCALL SDL_CloseIO(SDL_IOStream *context);
 ...
 * \sa SDL_TellIO
 */
extern DECLSPEC Sint64 SDLCALL SDL_SeekIO(SDL_IOStream *context, Sint64 offset, SDL_IOWhence whence);
 ...
 * \sa SDL_WriteIO
 */
	extern DECLSPEC size_t SDLCALL SDL_IOprintf(SDL_IOStream *context, SDL_PRINTF_FORMAT_STRING const char *fmt, ...);
/**
 * Print to an SDL_IOStream data stream.
 *
 * This function does formatted printing to the stream.
 ...
 * \sa SDL_WriteIO
 */
	extern DECLSPEC size_t SDLCALL SDL_IOvprintf(SDL_IOStream *context, SDL_PRINTF_FORMAT_STRING const char *fmt, va_list ap);
 ...
 * \sa SDL_WriteIO
 */
extern DECLSPEC SDL_bool SDLCALL SDL_FlushIO(SDL_IOStream *context);
 ...
 * \sa SDL_SaveFile
 */
extern DECLSPEC void * SDLCALL _SDL_LoadFile(const char *file, size_t *datasize);
 ...
 * \sa SDL_LoadFile_IO
 */
extern DECLSPEC SDL_bool SDLCALL SDL_SaveFile_IO(SDL_IOStream *src, const void *data, size_t datasize, SDL_bool closeio);
 ...
 * \sa SDL_LoadFile
 */
extern DECLSPEC SDL_bool SDLCALL SDL_SaveFile(const char *file, const void *data, size_t datasize);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern DECLSPEC SDL_bool SDLCALL SDL_ReadU8Ptr(SDL_IOStream *src, Uint8 *value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern DECLSPEC SDL_bool SDLCALL SDL_ReadS8(SDL_IOStream *src, Sint8 *value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern DECLSPEC SDL_bool SDLCALL SDL_WriteU8Ptr(SDL_IOStream *dst, Uint8 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern DECLSPEC SDL_bool SDLCALL SDL_WriteS8(SDL_IOStream *dst, Sint8 value);
